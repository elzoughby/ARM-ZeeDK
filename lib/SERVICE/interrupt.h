...
typedef enum {
    ...
    INTR_IRQ_TIMER5A,
    INTR_IRQ_TIMER5B,
    INTR_IRQ_WIDE_TIMER0A,
    INTR_IRQ_WIDE_TIMER0B,
    INTR_IRQ_WIDE_TIMER1A,
    INTR_IRQ_WIDE_TIMER1B,
    INTR_IRQ_WIDE_TIMER2A,
    INTR_IRQ_WIDE_TIMER2B,
    INTR_IRQ_WIDE_TIMER3A,
    INTR_IRQ_WIDE_TIMER3B,
    INTR_IRQ_WIDE_TIMER4A,
    INTR_IRQ_WIDE_TIMER4B,
    INTR_IRQ_WIDE_TIMER5A,
    INTR_IRQ_WIDE_TIMER5B,
    INTR_IRQ_FPU,
    INTR_IRQ_RESERVED33,
    INTR_IRQ_RESERVED34,
    INTR_IRQ_I2C4,
